            ...
            <body>
                <div class="login-container">
                    ...
                    <div class="login-footer">
                        <a href="/" class="footer-link">← Volver al Chat Principal</a>
                    </div>
                </div>
            </body>
            </html>
            ...
            <div class="main-content">
                <div class="chat-header">
                    ...
                    <div class="header-actions">
                        ...
                        <button class="header-btn secondary" onclick="window.open('/admin/login', '_blank')">
                            📊 Admin DB
                        </button>
                    </div>
                </div>
...
# Rutas de administración protegidas - CON DISEÑO MEJORADO
@app.route('/admin')
@login_required
def admin_dashboard():
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Dashboard Admin - Autopartes Verese Sac</title>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        <style>
            :root {{
                --primary: #10a37f;
    ...
    <body>
        <div class="admin-container">
            <div class="admin-header">
                <div class="header-left">
                    ...
                    <div class="admin-titles">
                        ...
                        <p>Autopartes Verese Sac - Sistema de Gestión</p>
                    </div>
                </div>
                <div class="header-actions">
                    <a href="/admin/inventario" class="admin-btn secondary">📦 Inventario</a>
                    <a href="/admin/ventas" class="admin-btn secondary">🛒 Ventas</a>
                    <a href="/admin/logout" class="admin-btn logout">🚪 Salir</a>
                </div>
            </div>
            ...
            <div class="navigation">
                <a href="/" class="admin-btn secondary">💬 Volver al Chat</a>
                <a href="/admin/inventario" class="admin-btn">📦 Ver Inventario Completo</a>
...
def admin_inventario():
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Inventario - Autopartes Verese Sac</title>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        <style>
            :root {{
                --primary: #10a37f;
        ...
        <div class="admin-container">
            <div class="admin-header">
                <div class="header-left">
                    ...
                    <div class="admin-titles">
                        ...
                        <p>Autopartes Verese Sac - Gestión de Productos</p>
                    </div>
                </div>
                <div class="header-actions">
                    <a href="/admin" class="admin-btn secondary">📊 Dashboard</a>
                    <a href="/admin/ventas" class="admin-btn secondary">🛒 Ventas</a>
                    <a href="/admin/logout" class="admin-btn logout">🚪 Salir</a>
                </div>
            </div>
            ...
            <div class="admin-section">
                <div class="section-header">
                    ...
                    <div class="header-actions">
                        <a href="/" class="admin-btn secondary">💬 Ir al Chat</a>
                    </div>
                </div>
                <table>
                    <thead>
            ...
            <div class="navigation">
                ...
                <a href="/" class="admin-btn secondary">💬 Ir al Chat Principal</a>
            </div>
        </div>
    </body>
    </html>
...
def admin_ventas():
    ...
    db = get_db()
    ventas = db.execute('''
        SELECT c.*, u.nombre as cliente_nombre, u.correo_electronico 
        FROM compras c 
        JOIN usuarios u ON c.usuario_id = u.id 
        ORDER BY c.fecha_compra DESC
    ''').fetchall()
    ...
    <head>
        <meta charset="UTF-8">
        <meta name="viewport" content="width=device-width, initial-scale=1.0">
        <title>Ventas - Autopartes Verese Sac</title>
        <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
        <style>
            :root {{
                --primary: #10a37f;
            ...
            <div class="admin-header">
                <div class="header-left">
                    ...
                    <div class="admin-titles">
                        ...
                        <p>Autopartes Verese Sac - Gestión Comercial</p>
                    </div>
                </div>
                <div class="header-actions">
                    <a href="/admin" class="admin-btn secondary">📊 Dashboard</a>
